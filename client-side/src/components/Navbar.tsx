...
const Navbar = () => {
  return (
    <div className='w-auto flex items-center justify-between p-2 '>
      ...
      <div className=' px-3 py-2 text-center backdrop-blur-[20px] backdrop-saturate-[155%] bg-white/7 rounded-md border-white/10'>
        <ul className="flex flex-col text-sm md:flex-row space-y-2 md:space-y-0 md:space-x-8 text-center">
          ...
          <li><Link href="/register" className=" hover:text-gray-300">Account</Link></li>
        </ul>
      </div>
    </div>
  )
