    ...
    return (
        <>
            <div className='flex justify-center items-center w-full h-[80vh] rounded-lg '>
                <form onSubmit={handleSubmit} className=' bg-white/7 backdrop-blur-[20px] backdrop-saturate-[155%] rounded-xl p-6 w-full max-w-md shadow-[0_0_25px_rgba(6,182,212,0.4)] border-2 border-[#0F172A]'>
